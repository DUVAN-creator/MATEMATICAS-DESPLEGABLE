...
// definimos variables para poder realizar las operaciones


function Calculate(){
    let numerador1 = document.getElementById("num1").value;
    let numerador2 = document.getElementById("num2").value;
    let denominador1 = document.getElementById("den1").value;
    let denominador2 = document.getElementById("den2").value;
    let operaciones = document.getElementById("operation").value; 
    const space = "&nbsp;&nbsp;";

    // variables que seran usadas para el resultado 
    let numResultado;
    let denResultado;
    ...
    ` 
    <nav> ${space} ${numResultado}</nav>
    ------
    <nav> ${space} ${denResultado}</nav>`
}